                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-element-list">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div
                                        class=" form-group {{ $errors->has('user_id') ? 'has-error' : ''}}nk-int-mk sl-dp-mn ">
                                        <h2>Chose User</h2>
                                    </div>
                                        ...
                                        <select class="chosen" name="user_id" data-placeholder="Choose a User...">
                                            @foreach($users as $user)
                                                <option value="{{$user->id}}"
                                                        @if(in_array($user->id,$company->users->pluck('id')))
                                                            selected
                                                        @endif
                                                > {{$user->name}}</option>
                                            @endforeach
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div
                                        class="form-group {{ $errors->has('company_type_id') ? 'has-error' : ''}}nk-int-mk sl-dp-mn">
                                        <h2>Chose Company Type</h2>
                                    </div>
                                    <div class="chosen-select-act fm-cmp-mg">
                                        <select class="chosen" name="company_type_id"
                                                data-placeholder="Choose a User...">
                                            @foreach($companyTypes as $type)
                                                <option value="{{$type->id}}"
                                                        @if($type->id === $company->type->id)
                                                            selected
                                                        @endif
                                                > {{$type->type}}</option>
                                            @endforeach
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div
                                        class=" form-group {{ $errors->has('currency_id') ? 'has-error' : ''}} nk-int-mk sl-dp-mn">
                                        ...
                                        <select class="chosen" name="currency_id" data-placeholder="Choose a User...">
                                            @foreach($currencies as $currency)
                                                <option value="{{$currency->id}}"
                                                        @if($currency->id === $company->currency->id)
                                                            selected
                                                        @endif
