                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>Companies</h2>
                                        <p>Welcome to Company View  Page</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-element-list">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group  ic-cmp-int">
                                        ...
                                        <div class="nk-int-st">
                                            <input type="text" disabled class="form-control" name="country" placeholder="Country"
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group  ic-cmp-int">
                                        ...
                                        <div class="nk-int-st">
                                            <input type="text" disabled class="form-control" placeholder="City" name="city"
                                                   value="{{$company->city??''}}">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group  ic-cmp-int">
                                        ...
                                        <div class="nk-int-st">
                                            <input type="text" disabled class="form-control" name="street" placeholder="street"
                                    ...
                                    <div class="form-group  ic-cmp-int">
                                        ...
                                        <div class="nk-int-st">
                                            <input type="text" class="form-control" name="number"
                                                   placeholder="Street address" value="{{$company->number??''}}">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group  ic-cmp-int">
                                        ...
                                        <div class="nk-int-st">
                                            <input type="text" disabled class="form-control" placeholder="Postal Code"
                                                   name="post" value="{{$company->post??''}}">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class=" form-group nk-int-mk sl-dp-mn ">
                                        <h2>Chosen User</h2>
                                    </div>
                                    <div class="form-group  ic-cmp-int">
                                        <div class="form-ic-cmp">
                                        ...
                                        <div class="nk-int-st">
                                            <input type="text" disabled class="form-control"
                                                   name="post" value="{{$company->user->name??''}}">
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div
                                        class="form-group nk-int-mk sl-dp-mn">
                                        <h2>Chosen Company Type</h2>
                                    </div>
                                    <div class="form-group  ic-cmp-int">
                                            <div class="form-ic-cmp">
                                            </div>
                                            <div class="nk-int-st">
                                                <input type="text" disabled class="form-control"
                                                       name="post" value="{{$company->type->type??''}}">
                                            </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <div class="form-group  ic-cmp-int">
                                            ...
                                            <div class="nk-int-st">
                                                <input type="text" disabled class="form-control"
                                                       name="post" value="{{$company->currency->currency??''}}">
                                            </div>
