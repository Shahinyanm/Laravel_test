...
<div class="error-page-area">
    ...
    <div class="error-page-wrap">
        ...
        <h2>Uuuups <span class="counter">404</span></h2>
        <p>Hi My firend, you need to register  or Login to see nice features</p>
        <a href="{{ route('register') }}" class="btn">{{ __('Register') }}</a>
        <a href="{{ route('login') }}" class="btn error-btn-mg">{{ __('Login') }}</a>
    </div>
</div>
